...
class DataOut_port3(OpenRTM_aist.DataFlowComponentBase):
  ...
  def onInitialize(self):
    ...
    self._outport1 = OpenRTM_aist.CSPOutPort("out1", self._data1, self._cspmanager)
    self._outport2 = OpenRTM_aist.CSPOutPort("out2", self._data2, self._cspmanager)
    self._outport3 = OpenRTM_aist.CSPOutPort("out3", self._data3, self._cspmanager)
    # Set OutPort buffer
